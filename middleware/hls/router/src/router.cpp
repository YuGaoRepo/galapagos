...
//         // const ap_uint<NETWORK_HEADER_LENGTH> network_table_unused[256],
...
// // #pragma HLS INTERFACE bram port=network_table_unused
...
// 	bool inFPGA = false;
// 	ap_uint <NETWORK_HEADER_LENGTH> network_addr_in = 0;
...
//     //             ap_uint <NETWORK_HEADER_LENGTH> network_addr_in = network_table[index];
...
// #endif
// #endif
//        network_addr_in = network_table[packetIn.dest*4];
//        //ap_wait_n(1);
//        *addr_out = network_addr_in;
